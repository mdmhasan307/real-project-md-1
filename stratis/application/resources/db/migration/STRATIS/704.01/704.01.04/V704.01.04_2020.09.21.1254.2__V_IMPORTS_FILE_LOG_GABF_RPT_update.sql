CREATE OR REPLACE FORCE EDITIONABLE VIEW "SGA"."V_IMPORTS_FILE_LOG_GABF_RPT"
...
WHERE (rdl.interface_name = 'GABF')
ORDER BY rdl.interface_name ASC, (TRUNC((rdl.created_date))) DESC;


GRANT SELECT ON "SGA"."V_IMPORTS_FILE_LOG_GABF_RPT" TO "STRATIS_USER";
