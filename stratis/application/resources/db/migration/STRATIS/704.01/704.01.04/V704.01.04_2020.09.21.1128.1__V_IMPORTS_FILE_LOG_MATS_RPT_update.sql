CREATE OR REPLACE FORCE EDITIONABLE VIEW "SGA"."V_IMPORTS_FILE_LOG_MATS_RPT"
...
WHERE (rdl.interface_name = 'MATS')
ORDER BY rdl.interface_name ASC, (TRUNC((rdl.created_date))) DESC;


GRANT SELECT ON "SGA"."V_IMPORTS_FILE_LOG_MATS_RPT" TO "STRATIS_USER";
