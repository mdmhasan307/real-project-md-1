 ...
 *
 * @author Duncan Mills (Oracle)
 * @author Steve Muench (Oracle)
 *     <p>
...
public class JSFUtils {
   ...
   */
  // FUTURE LEGACY 18 uses or less....down to 1 or 0...
  ...
  public static Object resolveExpression(ValueExpression expression) {
    val facesContext = getFacesContext();
    val elContext = facesContext.getELContext();
  ...
  public static String getPageURL(String view) {
    ...
    StringBuffer newUrlBuffer = new StringBuffer(160);
