...
@Mapper
public interface ImportFileLogMhifRptViewMapper {

  ImportFileLogMhifRptViewMapper INSTANCE = Mappers.getMapper(ImportFileLogMhifRptViewMapper.class);

  ImportFileLogMhifRptView entityToModel(ImportFileLogMhifRptViewEntity importFileLogMhifRptViewEntity);

  List<ImportFileLogMhifRptView> entityListToModelList(List<ImportFileLogMhifRptViewEntity> entitySet);

  List<ReportColumnBean> modelListToReportColumnList(List<ImportFileLogMhifRptView> modelSet);

  @Mapping(source = "createdDate", target = "createdDate", qualifiedByName = "dateFormatting")
  @Mapping(source = "status", target = "dataRow")
  ReportColumnBean modelToReportColumn(ImportFileLogMhifRptView importFile);
