...
@AllArgsConstructor
@ToString
public class ChangeLocationEvent implements Event {

  private static final String LABEL = "Location Changed";
  ...
  private static ChangeLocationEventBuilder builder() { return new ChangeLocationEventBuilder(); }

  public static ChangeLocationEventBuilder builder(AuditLogTypeEnum result) {
    return new ChangeLocationEventBuilder().result(result);
  }
