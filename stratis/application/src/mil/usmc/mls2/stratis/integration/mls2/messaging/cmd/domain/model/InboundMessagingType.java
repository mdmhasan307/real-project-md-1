...
public enum InboundMessagingType implements StandardType<Integer> {
  ...
  I111_DASF_RESPONSE(2, "I111 GCSS DASF Data Response", "Response to STRATIS to retrieve new DASF DAC data available.", MessageType.STRATIS_GCSS_DASF_RESPONSE),
  I033_GABF_RESPONSE(3, "I033 GCSS GABF Data Response", "Response to STRATIS to read page of GABF data available.", MessageType.STRATIS_GCSS_GABF_RESPONSE),
