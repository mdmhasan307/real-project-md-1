...
CLASSPATH="./model-704.01.01.jar:./efxlic_stratisintegration12.jar:$BASEDIR/lib/*:$BASEDIR/RICE_INTF/:$BASEDIR/classes/:$BASETOMCATDIR/lib/*:$BASETOMCATDIR/bin/*"
...
echo java $EXTRA_OPTS -cp "$CLASSPATH" mil.stratis.model.threads.imports.HostnameTester
...
$JAVA_EXE $EXTRA_OPTS -cp "$CLASSPATH" -Djava.security.manager -Djava.security.policy=tester.policy mil.stratis.model.threads.imports.HostnameTester

echo ""
echo "NOW TESTING WITH BETTER CATALINA.POLICY - FQDN"
echo ""

$JAVA_EXE $EXTRA_OPTS -cp "$CLASSPATH" -Djava.security.manager -Djava.security.policy=goodtester.policy mil.stratis.model.threads.imports.HostnameTester

echo ""
echo "NOW TESTING WITH BETTER CATALINA.POLICY - just hostname"
echo ""

$JAVA_EXE $EXTRA_OPTS -cp "$CLASSPATH" -Djava.security.manager -Djava.security.policy=goodtester2.policy mil.stratis.model.threads.imports.HostnameTester
