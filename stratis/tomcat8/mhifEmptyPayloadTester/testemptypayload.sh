...
echo java $EXTRA_OPTS -cp "$CLASSPATH" mil.stratis.model.threads.imports.ExportIMHIFEmptyPayloadTester ./testemptypayload.conf
...
$JAVA_EXE $EXTRA_OPTS -cp "$CLASSPATH" mil.stratis.model.threads.imports.ExportIMHIFEmptyPayloadTester ./testemptypayload.conf
